...
import fr.paidou.paidou.controller.commun.EnfantController.EnfantStatutGlobalDTO;
import fr.paidou.paidou.controller.commun.EnfantController.VaccinStatusDTO;
...
public class EnfantService {
    ...
    public List<VaccinStatusDTO> getStatutVaccinal(Long enfantId) {
        ...
        for (Vaccin v : vaccins) {
            if (v.getNeAvantLe() != null && !enfant.getDateDeNaissance().isBefore(v.getNeAvantLe())) continue;
            if (v.getNeApresLe() != null && enfant.getDateDeNaissance().isBefore(v.getNeApresLe())) continue;
