...
const Vaccins = () => {
  ...
  const handleObsolete = async () => {
    ...
    try {
      for (const v of getSelectedVaccins()) {
        await axios.put("/api/vaccins/rendre-obsolete", { id: v.id }, { withCredentials: true });
      }
      fetchVaccins();
    } catch (e) { alert(e.response?.data || "Erreur"); }
  };
  ...
  const handleReactiver = async () => {
    ...
    try {
      for (const v of getSelectedVaccins()) {
        await axios.put("/api/vaccins/reactiver", { id: v.id }, { withCredentials: true });
      }
      fetchVaccins();
    } catch (e) { alert(e.response?.data || "Erreur"); }
  };
  ...
  const handleSupprimer = async () => {
    ...
    try {
      for (const v of getSelectedVaccins()) {
        await axios.delete("/api/vaccins/delete", { data: { id: v.id }, withCredentials: true });
      }
      setSelectedIds([]);
      fetchVaccins();
    } catch (e) { alert(e.response?.data || "Erreur"); }
